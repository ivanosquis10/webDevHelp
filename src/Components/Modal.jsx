                    ...
                    <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2 font-medium text-start">
                        <p className="text-sm font-thin text-gray-400 mb-2">
                          ...
                          front-end para que sea más fácil y rápido de encontrar
                          y usar.
                        </p>
                        <p className="text-sm font-thin text-gray-400 mb-2">
                          Quiero destacar que es un proyecto totalmente de
                          práctica y para ver de que soy capaz de desarrollar,
                          todos estos recursos los recolecte de diferentes
                          tweets de otros desarrolladores, los cuales deje sus
                          tweets
                        </p>
                        <p className="text-sm font-thin text-gray-400 mb-2">
                          Quiero agradecerle a todos esos desarolladores que se
                          toman el tiempo de publicar toda esa información
                          porque realmente es muy útil, sobretodo cuando estás
                          aprendiendo :D
                        </p>
                        <p className="text-sm text-gray-400 font-medium">
                          PD: Esto me da mucha pena pero realmente no cuento con
                          una buena computadora, de hecho se puede ver en el
                          repositorio que hago este proyecto desde un editor
                          online porque no puedo usar muchos programas porque
                          EXPLOTA :(,entonces si quieres donar, pedirme algún
                          trabajo o algo así, me puedes escribir a mi twitter
                          que esta al final, gracias y disfruta :D
                        </p>
                      </div>
                    </div>
                  </div>
